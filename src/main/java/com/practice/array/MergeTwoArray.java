...
public class MergeTwoArray {
	...
	private ResponseEntity<APIResponse<int[]>> mergeTwoArrayUsingLoop(@RequestBody APIRequest apiRequest) {
		LOGGER.info("call api for merge two array:");
		return mergeTwoArrayUsingLoopMain(apiRequest);
	}

	private ResponseEntity<APIResponse<int[]>> mergeTwoArrayUsingLoopMain(APIRequest apiRequest) {
		try {
